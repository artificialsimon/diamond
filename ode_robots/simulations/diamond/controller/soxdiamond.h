 ...
 *                                                                         *
 ***************************************************************************/
#ifndef __SOX_DIAMOND_H
#define __SOX_DIAMOND_H
...
/// configuration object for SoxDiamond controller. Use SoxDiamond::getDefaultConf().
struct SoxDiamondConf {
 ...
 */
class SoxDiamond : public AbstractController, public Teachable, public Parametrizable {

public:
  /// constructor
  SoxDiamond(const SoxDiamondConf& conf = getDefaultConf());

  /// constructor provided for convenience, use conf object to customize more
  SoxDiamond(double init_feedback_strength, bool useExtendedModel = true,
  ...
  static SoxDiamondConf getDefaultConf(){
    SoxDiamondConf conf;
...
protected:
  ...
  SoxDiamondConf conf; ///< configuration objects
